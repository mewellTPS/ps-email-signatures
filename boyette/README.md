...
## Files
- `signature-boyette.html` — the CodeTwo-ready snippet (keeps dynamic `{fields}`).
- `preview.html` — open in a browser to see the rendered look (sample data).
- `assets/boy-logo.png` — logo, 320×221 (displays at 160×110).
- `assets/endorsement.png` — shared "Powered by The Purple Standard" strip, under the logo, display 180×9 (source 600×29).
...
2. Paste the contents of `signature-boyette.html`.
3. Upload the five images from `assets/` via the editor's image tool (CodeTwo hosts them
